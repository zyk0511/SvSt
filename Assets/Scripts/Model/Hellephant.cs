...
namespace Enemy{
	...
	public class Hellephant
	{
		...
		public Hellephant (GameObject gameObj)
		{
		...
		public void InitSphereCollider ()
		{
			...
			sphereCollider.center = new Vector3 (0.0f, 1.23f, 0.0f);
			sphereCollider.radius = 1.65f;
		}
		...
		{
			audioSource.clip.name = "Hellephant Hurt";
		...
		public void InitScript()
		{
			...
			enemyHealth.startingHealth = 300;
			...
			enemyMovement.movingSpeed = 1.5f;
		}
	}
}
